...
class TodayNoteScreen extends StatefulWidget {
  const TodayNoteScreen({Key? key}) : super(key: key);

  @override
  _TodayNoteScreenState createState() => _TodayNoteScreenState();
}

class _TodayNoteScreenState extends State<TodayNoteScreen> {
