...
class UpcomingNoteScreen extends StatefulWidget {
  const UpcomingNoteScreen({Key? key}) : super(key: key);

  @override
  _UpcomingNoteScreenState createState() => _UpcomingNoteScreenState();
}

class _UpcomingNoteScreenState extends State<UpcomingNoteScreen> {
